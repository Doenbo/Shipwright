...
typedef enum {
    ...
    TEXT_ADV_WARP_MINUET_OF_FOREST = 0x0893,
    TEXT_ADV_WARP_BOLERO_OF_FIRE = 0x0894,
    TEXT_ADV_WARP_SERENADE_OF_WATER = 0x0895,
    TEXT_ADV_WARP_REQUIEM_OF_SPIRIT = 0x0896,
    TEXT_ADV_WARP_NOCTURNE_OF_SHADOW = 0x0897,
    TEXT_ADV_WARP_PRELUDE_OF_LIGHT = 0x0898,
